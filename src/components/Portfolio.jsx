      ...
      <div className="container-custom" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))', gap: '24px', marginBottom: '3rem' }}>
          {projects.map(project => (
            <div key={project.id} className="glass-card" style={{ padding: '2rem', position: 'relative', overflow: 'hidden' }}>
              {/* Color Accent */}
              <div style={{
                position: 'absolute', top: 0, left: 0, width: 4, height: '100%',
                background: project.color, transition: 'width 0.3s'
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <a href={project.github} target="_blank" rel="noopener noreferrer"
                      style={{ padding: 8, borderRadius: 8, background: 'rgba(255,255,255,0.05)', color: '#6b7280' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="btn-primary"
            style={{ background: 'linear-gradient(135deg, #7b2ff7, #ec4899)' }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 13, marginTop: 12 }}>
            ...
            <a href={personalInfo.portfolio} target="_blank" rel="noopener noreferrer"
              style={{ color: '#00f0ff', textDecoration: 'underline', textUnderlineOffset: 4 }}>
