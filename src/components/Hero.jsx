  ...
  return (
    <section id="hero" style={{
      ...
      <div className="container-custom" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
        ...
        {/* Role Tags */}
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '12px', marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: '#6b7280', maxWidth: 600, margin: '0 auto 2.5rem', fontSize: '1rem' }}>
          ...
          <span style={{ color: '#00f0ff' }}>technology</span> and{' '}
          <span style={{ color: '#a78bfa' }}>law</span> — automating workflows while ensuring regulatory precision.
        </p>
