    ...
    <section id="about" className="section-padding" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container-custom" style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          <div className="badge badge-secondary" style={{ margin: '0 auto 1rem', width: 'fit-content' }}>
            About Me
          </div>
          <h2 className="font-orbitron" style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 'bold', color: 'white', marginBottom: '1rem' }}>
            Who <span className="text-gradient">I Am</span>
          </h2>
          <div style={{ width: 80, height: 4, background: 'linear-gradient(90deg, #00f0ff, #7b2ff7, #00ffff, #ff00ff)', margin: '0 auto', borderRadius: 2 }} />
        </div>

        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0, transition: { delay: 0.2, staggerChildren: 0.2 } }}
        >
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            ...
            >
              <div className="glass-card" style={{ padding: '2rem', textAlign: 'center' }}>
                <div style={{
                  ...
                  background: 'linear-gradient(135deg, rgba(0,240,255,0.2), rgba(0,255,255,0.2), rgba(123,47,247,0.2))',
                ...
                <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: 8 }}>
                  <div style={{ fontSize: 13, color: '#6b7280' }}>
                    <span style={{ color: '#00ffff' }}>🎓</span> GPA 3.82 — Cum Laude
                  </div>
                  <div style={{ fontSize: 13, color: '#6b7280' }}>
                    <span style={{ color: '#ffff00' }}>⚡</span> 6+ Years Experience
                  </div>
                </div>

                {/* Education */}
                <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  <h4 style={{ fontSize: 11, fontFamily: "'Orbitron', monospace", color: '#00ffff', marginBottom: 12, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    🎓 Education
                  </h4>
                  {education.map((edu, i) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0, transition: { delay: 0.3 * i, duration: 0.3 } }}
                    ...
                    >
                      <div key={edu.degree}>
                        ...
                        <div style={{ display: 'flex', gap: 8, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
                          <span style={{ padding: '4px 12px', borderRadius: 999, background: 'rgba(0,255,255,0.1)', border: '1px solid rgba(0,255,255,0.2)', color: '#00ffff', fontSize: 11 }}>
                            GPA: {edu.gpa}
                          </span>
                          <span style={{ padding: '4px 12px', borderRadius: 999, background: 'rgba(255,255,0,0.1)', border: '1px solid rgba(255,255,0,0.2)', color: '#ffff00', fontSize: 11 }}>
                            {edu.honors}
                          </span>
                        </div>
                        <p style={{ color: '#6b7280', fontSize: 11, marginTop: 8 }}>
                          <span style={{ color: '#bf00ff' }}>Thesis:</span> {edu.thesis}
                        </p>
                      </div>
                    </motion.div>
                  ))}
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                >
                  <div className="glass-card" style={{ padding: '2rem' }}>
                    <h4 className="font-orbitron" style={{ fontSize: 12, color: '#bf00ff', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                ...
                >
                  <div className="glass-card" style={{ padding: '2rem' }}>
                    <h4 className="font-orbitron" style={{ fontSize: 12, color: '#00ffff', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      📡 Connect
                    </h4>
